    ...
    <div class="row justify-content-center">
      <div class="col-lg-7 text-center">
        <div class="section-title">
         <span class="h5 text-color">Recomendations</span>
        </div>
      </div>
    </div>
...
<?php 
                                    ...
                                    $etab = $_SESSION['etab'];
                                        ...
                                        $query =  "SELECT * FROM post WHERE niveau='$niveau'or genre='roman' AND etablissement ='$etab' AND en ='sell' ORDER BY  date_post DESC  Limit 12";
